...
#ifndef	_CLEVEL3AREA1_H_
#define	_CLEVEL3AREA1_H_
...
private:
	...
	bool					m_bSquareWasPressed;

	TickerText*				m_pcFirstTutorialTickerText;

	const std::string&		m_crFirstTutorialText = "Hey Danielle, you know you can fight back right? Press square to fire your disruptor pistol. You can use it to temporarily disable enemies.";
