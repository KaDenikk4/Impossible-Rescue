...
static OldEPlayerActions			s_aePlayerActions[]	= { EPA_AxisMove_X,								EPA_AxisMove_Y,								EPA_ButtonFire };
...
void CGCObjPlayer::UpdateMovement( f32 fTimeStep )
{
	...
	TGCController< OldEPlayerActions > cController = TGetActionMappedController( CGCControllerManager::eControllerOne, (*m_pcControllerActionToKeyMap ) );
