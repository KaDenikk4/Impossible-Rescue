...
public:
	...
	// Accessors for Editor Data
	const tinyxml2::XMLElement* GetEditorData() const
	{
		return m_pxmlEditorData;
	}

	void SetEditorData(const tinyxml2::XMLElement* pxmlEditorData)
	{
		m_pxmlEditorData = pxmlEditorData;
	}
	// Accessors for Editor Data

private:
	const tinyxml2::XMLElement* m_pxmlEditorData;
};
